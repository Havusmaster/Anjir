...
<template>
  <div>
    ...
    <div class="section section-tight">
      <div class="container">
        <div v-reveal class="grid grid-cols-1 lg:grid-cols-[1.05fr_.95fr] gap-8 lg:gap-16 items-center">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-px bg-line border border-line rounded-lg overflow-hidden">
            <div v-for="s in STATS" :key="s.s" class="bg-elev p-6">
    ...
    <div class="section section-tight">
      <div class="container">
        <div v-reveal class="max-w-[660px] mb-12">
        ...
        <div v-reveal class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          <div v-for="p in PRINCIPLES" :key="p.pn" class="border-t border-line pt-4">
    ...
    <div class="section section-tight">
      <div class="container">
        ...
        <div v-reveal class="flex flex-wrap gap-2 mt-6">
          <div
            v-for="step in PROCESS"
            :key="step.n"
            class="flex-1 min-w-[132px] border border-line rounded-md p-5 px-4 transition-all bg-elev hover:border-accent/30 hover:bg-accent-fill"
          >
