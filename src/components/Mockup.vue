...
<template>
  <!-- Mobile mock -->
  <svg v-if="kind === 'mobile'" class="mock-ui w-full h-full" viewBox="0 0 400 225" preserveAspectRatio="xMidYMid slice">
    ...
    <g transform="translate(150 26)">
      ...
      <rect width="100" height="42" rx="14" :fill="c" />
      ...
      <rect x="12" y="118" width="76" height="26" rx="6" :fill="c" opacity="0.16" />
      <circle cx="24" cy="131" r="6" :fill="c" />
      <rect x="36" y="128" width="40" height="5" rx="2.5" fill="var(--color-ink3)" />
      <rect x="30" y="160" width="40" height="6" rx="3" :fill="c" />
    </g>
    <circle cx="60" cy="60" r="30" :fill="c" opacity="0.10" />
    <circle cx="340" cy="170" r="40" :fill="c" opacity="0.08" />
  </svg>

  <!-- Backend mock -->
  <svg v-else-if="kind === 'backend'" class="mock-ui w-full h-full" viewBox="0 0 400 225" preserveAspectRatio="xMidYMid slice">
    <rect width="400" height="225" fill="var(--color-surface2)" />
    <g font-family="JetBrains Mono, monospace" font-size="9" fill="var(--color-ink3)">
      ...
      <text x="40" y="86" :fill="c">200 OK · 42ms</text>
      <text x="40" y="108">{</text>
      <text x="56" y="122">"id": <tspan :fill="c">"a3f…"</tspan>,</text>
      <text x="56" y="136">"deck": <tspan :fill="c">"vocab"</tspan>,</text>
      ...
      <rect x="244" y="76" width="70" height="6" rx="3" :fill="c" />
      ...
      <rect x="244" y="140" width="50" height="18" rx="4" :fill="c" opacity="0.2" />
    </g>
  </svg>

  <!-- Web mock -->
  <svg v-else class="mock-ui w-full h-full" viewBox="0 0 400 225" preserveAspectRatio="xMidYMid slice">
    <rect width="400" height="225" fill="var(--color-surface2)" />
    ...
    <rect x="24" y="54" width="150" height="18" rx="4" :fill="c" />
    ...
    <rect x="24" y="118" width="70" height="22" rx="5" :fill="c" />
    ...
    <rect x="274" y="68" width="60" height="8" rx="4" :fill="c" opacity="0.8" />
    ...
    <rect x="274" y="120" width="88" height="40" rx="6" :fill="c" opacity="0.12" />
    <circle cx="60" cy="185" r="14" :fill="c" opacity="0.14" />
  </svg>
</template>
